...
async def run_playwright(request: Request):
    ...
    args = [
        ...
        data.get("entity_zip", ""),
        data.get("member_name_zero", ""),
        data.get("member_title_zero", ""),
        data.get("member_ownership_zero", ""),
        data.get("member_address_zero", ""),
        data.get("member_cell_zero", ""),
        data.get("member_ssn_zero", ""),
        data.get("member_dob_zero", ""),
        data.get("member_email_zero", ""),
        data.get("member_fico_score_zero", ""),
        data.get("member_guarantor_zero", ""),
        data.get("member_citizenship_zero", ""),
        data.get("member_name_one", ""),
        data.get("member_title_one", ""),
        data.get("member_ownership_one", ""),
        data.get("member_address_one", ""),
        data.get("member_cell_one", ""),
        data.get("member_ssn_one", ""),
        data.get("member_dob_one", ""),
        data.get("member_email_one", ""),
        data.get("member_fico_score_one", ""),
        data.get("member_guarantor_one", ""),
        data.get("member_citizenship_one", ""),
        data.get("member_name_two", ""),
        data.get("member_title_two", ""),
        data.get("member_ownership_two", ""),
        data.get("member_address_two", ""),
        data.get("member_cell_two", ""),
        data.get("member_ssn_two", ""),
        data.get("member_dob_two", ""),
        data.get("member_email_two", ""),
        data.get("member_fico_score_two", ""),
        data.get("member_guarantor_two", ""),
        data.get("member_citizenship_two", ""),
        data.get("member_name_three", ""),
        data.get("member_title_three", ""),
        data.get("member_ownership_three", ""),
        data.get("member_address_three", ""),
        data.get("member_cell_three", ""),
        data.get("member_ssn_three", ""),
        data.get("member_dob_three", ""),
        data.get("member_email_three", ""),
        data.get("member_fico_score_three", ""),
        data.get("member_guarantor_three", ""),
        data.get("member_citizenship_three", ""),
        data.get("member_name_four", ""),
        data.get("member_title_four", ""),
        data.get("member_ownership_four", ""),
        data.get("member_address_four", ""),
        data.get("member_cell_four", ""),
        data.get("member_ssn_four", ""),
        data.get("member_dob_four", ""),
        data.get("member_email_four", ""),
        data.get("member_fico_score_four", ""),
        data.get("member_guarantor_four", ""),
        data.get("member_citizenship_four", ""),
        data.get("member_name_five", ""),
        data.get("member_title_five", ""),
        data.get("member_ownership_five", ""),
        data.get("member_address_five", ""),
        data.get("member_cell_five", ""),
        data.get("member_ssn_five", ""),
        data.get("member_dob_five", ""),
        data.get("member_email_five", ""),
        data.get("member_fico_score_five", ""),
        data.get("member_guarantor_five", ""),
        data.get("member_citizenship_five", ""),
        data.get("lb_contact_name", ""),
        data.get("lb_contact_email", ""),
        data.get("lb_contact_phone", ""),
        data.get("monthly_hoa_fees", ""),
        data.get("actual_rents_in_place", ""),
        data.get("spcf_hoafees", ""),
        data.get("title_seller", ""),
        data.get("title_name", ""),
        data.get("title_order_number", ""),
        data.get("pro_ins_first_name_1", ""),
        data.get("pro_ins_last_name_1", ""),
        data.get("pro_ins_name_1", ""),
        data.get("pro_inc_email_1", ""),
        data.get("pro_inc_ph_1", ""),
        data.get("unit_type_1_1", ""),
        data.get("unit_num_1_1", ""),
        data.get("sq_ft_1_1", ""),
        data.get("rent_roll_market_rents_1_1", ""),
        data.get("rent_roll_actual_rents_1_1", ""),
        data.get("rent_roll_monthly_rent_1_1", ""),
        data.get("unit_type_1_2", ""),
        data.get("unit_num_1_2", ""),
        data.get("sq_ft_1_2", ""),
        data.get("rent_roll_market_rents_1_2", ""),
        data.get("rent_roll_actual_rents_1_2", ""),
        data.get("rent_roll_monthly_rent_1_2", ""),
        data.get("unit_type_1_3", ""),
        data.get("unit_num_1_3", ""),
        data.get("sq_ft_1_3", ""),
        data.get("rent_roll_market_rents_1_3", ""),
        data.get("rent_roll_actual_rents_1_3", ""),
        data.get("rent_roll_monthly_rent_1_3", ""),
        data.get("unit_type_1_4", ""),
        data.get("unit_num_1_4", ""),
        data.get("sq_ft_1_4", ""),
        data.get("rent_roll_market_rents_1_4", ""),
        data.get("rent_roll_actual_rents_1_4", ""),
        data.get("rent_roll_monthly_rent_1_4", ""),
        data.get("unit_type_1_5", ""),
        data.get("unit_num_1_5", ""),
        data.get("sq_ft_1_5", ""),
        data.get("rent_roll_market_rents_1_5", ""),
        data.get("rent_roll_actual_rents_1_5", ""),
        data.get("rent_roll_monthly_rent_1_5", ""),
        data.get("unit_type_1_6", ""),
        data.get("unit_num_1_6", ""),
        data.get("sq_ft_1_6", ""),
        data.get("rent_roll_market_rents_1_6", ""),
        data.get("rent_roll_actual_rents_1_6", ""),
        data.get("rent_roll_monthly_rent_1_6", ""),
        data.get("unit_type_1_7", ""),
        data.get("unit_num_1_7", ""),
        data.get("sq_ft_1_7", ""),
        data.get("rent_roll_market_rents_1_7", ""),
        data.get("rent_roll_actual_rents_1_7", ""),
        data.get("rent_roll_monthly_rent_1_7", ""),
        data.get("unit_type_1_8", ""),
        data.get("unit_num_1_8", ""),
        data.get("sq_ft_1_8", ""),
        data.get("rent_roll_market_rents_1_8", ""),
        data.get("rent_roll_actual_rents_1_8", ""),
        data.get("rent_roll_monthly_rent_1_8", ""),
        data.get("unit_type_1_9", ""),
        data.get("unit_num_1_9", ""),
        data.get("sq_ft_1_9", ""),
        data.get("rent_roll_market_rents_1_9", ""),
        data.get("rent_roll_actual_rents_1_9", ""),
        data.get("rent_roll_monthly_rent_1_9", ""),
        data.get("unit_type_1_10", ""),
        data.get("unit_num_1_10", ""),
        data.get("sq_ft_1_10", ""),
        data.get("rent_roll_market_rents_1_10", ""),
